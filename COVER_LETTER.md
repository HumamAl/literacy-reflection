...
Similar systems I've shipped: an AI classification pipeline using OpenAI structured output (WMF Agent), a CRUD-heavy SaaS dashboard (Fleet Maintenance), and Stripe subscription billing (Creator Platform) — all in the Next.js stack.
